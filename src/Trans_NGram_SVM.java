...
public class Trans_NGram_SVM {
	...
	/*
	 * 输入所有的语句单元，每个单元经多重NGram算法，返回所有语句单元的NGram处理结果
	 */
	...
	public static void outputTrain(String opt) {
		try {
			...
			for (int i = 1; i < 12; i++) {
				datapath.append("/Users/Meng/Documents/我的文档/华为/LIBSVM/fun/test/" + String.valueOf(i) + ".txt");// 循环读取各类别的控制语句
				...
				for (String s : sen4each) {// 循环处理每个语句单元
					...
					gram4each = new ArrayList<String>(new HashSet<String>(sen2gram(str2ar)));// 除去单个语句单元中重复出现的特征
	...
	public static void main(String[] args) {
		...
		String opFileName = "/Users/Meng/Documents/我的文档/华为/LIBSVM/feature_data/feature_data_test_123Gram";
		String optFileName = "/Users/Meng/Documents/我的文档/华为/LIBSVM/train_data/train_data_test_123Gram";
